            ...
            <div className="grid grid-cols-2 h-[450px] bg-brand-surface/50">
              ...
              <div className="p-8 bg-brand-surface relative">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <div className="text-sm text-brand-text-primary font-serif leading-relaxed space-y-4">
                    <div>
                    ...
                    <div>8.1 Termination. Either party may terminate this Agreement for convenience with thirty (30) days prior written notice.</div>
                  </div>
              </div>
            </div>
          </div>
